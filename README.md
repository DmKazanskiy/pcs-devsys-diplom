...
```
> Артефакты скрипт распечатывания, корневой, промежуточные сертификаты центра сертификации, а также серверный сертификат и соотвествующие публичный и приватный ключи находятся в папке [vagrant_data](assets/README.md).
